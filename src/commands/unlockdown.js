...
module.exports = class extends Command {
    ...
    message.guild.channels.cache.find(ch => ch.name === "🔒┃lockdown");
     ...
     "853316000334348288", "856786023928954890", "853316017073160233", "853323425606008842", "853323392844300308"
 ]);
     ...
     serverChannels.forEach(channel => {
         if(!ignored.has(channel.id)) {
             if(channel.type === "text") {
                channel.updateOverwrite(channel.guild.roles.cache.get("853323459098443776"), { VIEW_CHANNEL: true });
     ...
     message.guild.channels.cache.get("857139930068287489") .updateOverwrite(message.guild.roles.cache.get("853323459098443776"), { VIEW_CHANNEL: false });
